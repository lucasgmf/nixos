        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Column {
                    spacing: 6
                    Text {
                        text: "MODE"; color: Appearance.m3colors.m3outline
                        font.pixelSize: Appearance.font.pixelSize.smallest
                        font.letterSpacing: 1.5; font.family: Appearance.font.family.main; font.weight: Font.Medium
                    }
                    Row {
                        spacing: 4
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                border.color: SchemePickerState.selectedMode === index
                                    ? Appearance.m3colors.m3primary : Appearance.colors.colOutlineVariant
                                border.width: 1
                                Text {
                                    anchors.centerIn: parent; text: parent.modelData
                                    color: SchemePickerState.selectedMode === parent.index
                                        ? Appearance.m3colors.m3onPrimaryContainer : Appearance.m3colors.m3onSurfaceVariant
                                    font.pixelSize: Appearance.font.pixelSize.smaller; font.family: Appearance.font.family.main
                                    font.weight: SchemePickerState.selectedMode === parent.index ? Font.Medium : Font.Normal
                                }
                                HoverHandler { id: mh }
                ...
                Column {
                    ...
                    RowLayout {
                        width: parent.width
                        Text {
                            text: "CONTRAST"; color: Appearance.m3colors.m3outline
                            font.pixelSize: Appearance.font.pixelSize.smallest
                            font.letterSpacing: 1.5; font.family: Appearance.font.family.main; font.weight: Font.Medium
                        }
                        Item { Layout.fillWidth: true }
                        Text {
                            ...
                            color: SchemePickerState.contrast === 0 ? Appearance.m3colors.m3outline : Appearance.m3colors.m3primary
                            font.pixelSize: Appearance.font.pixelSize.smaller; font.family: Appearance.font.family.numbers; font.weight: Font.Medium
                        }
                    }
                    StyledSlider {
                        width: parent.width
            ...
            RowLayout {
                ...
                Text {
                    ...
                    color: Appearance.m3colors.m3outline
                    font.pixelSize: Appearance.font.pixelSize.smallest; font.family: Appearance.font.family.main
                }
            }
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    color: SchemePickerState.selectedScheme === index
                        ? Appearance.colors.colLayer2 : (dh.containsMouse ? Appearance.colors.colLayer1Hover : "transparent")
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            width: 3; height: 24; radius: Appearance.rounding.full
                            color: SchemePickerState.selectedScheme === index ? Appearance.m3colors.m3primary : "transparent"
                            Behavior on color { ColorAnimation { duration: Appearance.animationCurves.expressiveEffectsDuration } }
                        }
                        Text {
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        MaterialSymbol {
                            ...
                            iconSize: 16; color: Appearance.m3colors.m3onPrimary
                        }
                        Text {
                            text: SchemePickerState.applying ? "Applying…" : "Apply Scheme"
                            color: Appearance.m3colors.m3onPrimary
                            font.pixelSize: Appearance.font.pixelSize.smaller; font.weight: Font.Medium; font.family: Appearance.font.family.main
                        }
                    }
                    HoverHandler { id: ah }
                    TapHandler {
